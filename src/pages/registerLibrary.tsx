                ...
                <section className="bg-bg-100 rounded-md w-full my-2 mx-10 pb-2" >
                   <form className="flex">
                        ...
                        <div className="flex-1/2 px-8 py-6 flex flex-col items-center gap-3" > 
                            ...
                            <InputText isBook={false} widthDiv="w-full" type="email" placeholder="Digite o email da biblioteca" label="Email"/>
                        ...
                        <div className="flex-1/2 px-8 py-6 w-full flex flex-col gap-3" >
                            ...
                            <InputText isBook={false} widthDiv="w-full" type="text"  placeholder="Digite seu cnpj" label="CNPJ"/>
