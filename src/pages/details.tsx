                            ...
                            <div className="flex flex-col justify-between gap-6 pb-4">
...

                                {
                                    ...
                                    <form className="flex justify-between gap-6 relative" >
                                        <button className="bg-bg-primary py-1 px-2 rounded-2xl border-1 border-but-100 text-but-100 cursor-pointer" >fazer pedido</button>
                                    ...
                                    <div className="flex w-full justify-end">
                                        <ButtonCard text="editar" link="/#" size="" />
                                    </div>
                                }
                            </div>
                ...
                <section className="flex mb-26 mx-10 gap-20">
                    ...
                    <section className="w-full h-23" >
                        <div className="py-4 flex">
                            <Link className="border-r-1 border-font-400 pr-8 text-lg hover:text-font-200" to={'/user/details'}>Comentários</Link>
                    
                            <Link className="border-l-1 border-font-400 pl-8 text-lg hover:text-font-200" to={'/user/details/assessments'}>Avaliações</Link>
                        </div>
                        <section>
                            <Outlet/>
                        </section>  
